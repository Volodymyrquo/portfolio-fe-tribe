...
export const ProjectsSection = () => {
  return (
    <section className="lb:py-24 pb-16">
            ...
            >
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="inline-flex gap-2 bg-gradient-to-r from-emerald-100 to-sky-400 bg-clip-text text-sm font-bold uppercase tracking-widest">
