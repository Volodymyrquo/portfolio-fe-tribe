    ...
    <div className="py-16 lg:py-24">
      <div className="container">
        <SectionHeader
          ...
          work."
        />
        <div className="mt-12 flex overflow-x-clip [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] lg:mt-20">
          <div className="animate-move-left flex flex-none gap-8 py-4 pr-8 [animation-duration:90s] hover:[animation-play-state:paused]">
            {[
